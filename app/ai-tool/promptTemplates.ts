...
export const PROMPT_TEMPLATES = [
  ...
  // With text overlay
  {
    ...
    prompt:
      "Add bold, modern text at the bottom center: 'Believe & Achieve'. Animate a gentle camera pan and bright lighting.",
  ...
  },
  {
    ...
    prompt:
      "Add the text: 'Make It Happen' in clean white font at the top. Animate background blur and soft motion.",
  ...
  },
  {
    ...
    title: "Branded Outro",
    prompt:
      "Animate a cinematic fade-in with your brand name 'Beta7 AI' in the lower right corner in small text. Use a dynamic camera zoom.",
