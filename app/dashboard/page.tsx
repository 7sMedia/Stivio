      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-indigo-900 via-violet-900 to-black px-4">
        <ResponsiveContainer>
          ...
          <motion.div
            ...
            className="w-full bg-indigo-900/90 rounded-3xl shadow-2xl border border-indigo-700/40 p-10 flex flex-col items-center relative"
          >
            <motion.div
          ...
          <div className="w-full mt-10 bg-indigo-900/80 rounded-3xl shadow-2xl border border-indigo-700/40 p-8 flex flex-col items-center">
          ...
          <div className="w-full mt-6 bg-indigo-900/80 rounded-3xl shadow-2xl border border-indigo-700/40 p-8 flex flex-col items-center">
